###########################################################################
## Makefile generated for component 'bbTest'. 
## 
## Makefile     : bbTest.mk
## Generated on : Thu Apr 18 12:21:44 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/bbTest.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/bbTest.elf
...
DEFINES_STANDARD = -DMODEL=bbTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c MW_MPU9250.c bbTest.c bbTest_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o MW_MPU9250.c.o bbTest.c.o bbTest_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
bbTest_data.c.o : bbTest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ext_svr.c.o : ext_svr.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
ext_work.c.o : ext_work.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtiostream_utils.c.o : rtiostream_utils.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rtiostream_interface.c.o : rtiostream_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
